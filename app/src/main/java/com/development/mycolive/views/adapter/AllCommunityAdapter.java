...
public class AllCommunityAdapter  extends RecyclerView.Adapter<AllCommunityAdapter.MyViewHolder> {
    ...
    private List<AllCommunityModel> communityList;
    ...
    public AllCommunityAdapter(Context context,List<AllCommunityModel> communityList) {
    ...
    public void onBindViewHolder(AllCommunityAdapter.MyViewHolder holder, int position) {
        AllCommunityModel AllCommunityModel = communityList.get(position);
